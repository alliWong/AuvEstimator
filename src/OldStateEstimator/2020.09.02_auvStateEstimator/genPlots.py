...
""" Plots """
###################### Robot X and Y ######################
def plotXY(simX, simY, linPosX, linPosY, rbtLinPosX, rbtLinPosY, estMapX, estMapY):  
    ...
    plt.plot(linPosX, linPosY, color = 'r', linestyle = '-', marker = 'o', fillstyle = 'none', linewidth = 1, markersize = markerSize, label = 'simulated measurement MAP')    
    plt.plot(rbtLinPosX, rbtLinPosY, color = 'g', linestyle = '-', marker = 'o', fillstyle = 'none', linewidth = 1, markersize = markerSize, label = 'simulated measurement BODY')    
