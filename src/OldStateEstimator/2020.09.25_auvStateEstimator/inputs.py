...
def senInputs():
    ...
    parser.add_argument('--dvl_rr', type = int, default = 10,
    ...
    parser.add_argument('--imu_acBiasVar', type = int, default = 2,
                        help='variance of the IMU linear acceleration bias sensor data [m/s^2]')   
    parser.add_argument('--imu_gyBiasVar', type = int, default = np.rad2deg(0.5),
                        help='variance of the IMU angular velocity bias sensor data [rad/s]') 
...
def estInputs():
    ...
    # Decide which sensors to use for pseudo linear velocity and position calculation    
    ...
    parser.add_argument('--rbt_R_angPos', type = int, default = np.rad2deg(0.5),
                        help='rotation [rad]')
